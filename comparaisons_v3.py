...
def description_du_produit(produit):
		
	try:
		description_du_produit=produit["product"]["description"]
		print "Description : "
...
def categorie_du_produit(produit):
		
	try:
		categorie_produit = produit["product"]["categories"][0]
		print "Categorie : "
...
def prix_du_produit(produit):
	...
	try:
		prix_produit = produit["product"]["price"]
		print "Prix : "
		print prix_produit
	except:
...
# ------------------------------------------------------------------------------------------------------------
# PRIX SOLDE DU PRODUIT
# ------------------------------------------------------------------------------------------------------------	
# La fonction retourne None ou le titre du produit
# Cette fonction suppose l'API REST Woocommerce en version legacy

def prix_solde_du_produit(produit):
		
	try:
		prix_solde_produit = produit["product"]["sale_price"]
		print "Prix solde: "
...
# local_ou_remote 1 : local, 2 : distant
	...
	#	
	description_produit_dans_la_bdd=description_du_produit(produit_dans_la_bdd)
	...
	categorie_produit_en_bdd = categorie_du_produit(produit_dans_la_bdd)
	...
	titre_produit_en_bdd = titre_du_produit(produit_dans_la_bdd)
	#print "titre_produit_en_bdd", titre_produit_en_bdd

	#On récupère le prix
	prix_produit_en_bdd = prix_du_produit(produit_dans_la_bdd)
	#print "prix_produit_en_bdd", prix_produit_en_bdd


	#On récupère le prix soldé
	prix_solde_produit_en_bdd = prix_solde_du_produit(produit_dans_la_bdd)
	#print "prix_solde_produit_en_bdd", prix_solde_produit_en_bdd
